...
def parse_args(script):
  ...
  parser.add_argument('--dataset', default='multi', help='miniImagenet/cub/cars/places/plantae/ChestX/CropDiseases/EuroSAT/ISIC, specify multi for training with multiple domains')
  parser.add_argument('--testset', default='cub', help='cub/cars/places/plantae/ChestX/CropDiseases/EuroSAT/ISIC, valid only when dataset=multi')
  parser.add_argument('--model', default=' VIT_S', help='model: VIT_S') 
  parser.add_argument('--method', default='baseline',   help='baseline/protonet')
  parser.add_argument('--stage', default='pretrain', help='pretrain/metatrain')
  ...
  parser.add_argument('--warmup_endingepoch', default=1, type=int)
  parser.add_argument('--startsize', default=14, type=int)
  parser.add_argument('--endsize', default=32, type=int)
  parser.add_argument('--sim', default=0.3, type=float)
  parser.add_argument('--sty_std', default=1000, type=float)
  parser.add_argument('-eval_datasets', nargs='+', type=str,default=['miniImagenet', 'CropDiseases', 'EuroSAT', 'ISIC', 'ChestX','ave'])
  parser.add_argument('--optimizer', default='adamW', type=str, choices=['adam', 'sgd', 'adamW'])
  parser.add_argument('--lr', default=0.001, type=float, help='')  # for adam
  parser.add_argument('--lr_fre', default=0.005, type=float, help='')
  ...
  parser.add_argument('--logit_margin', type=float, default=0.0)
  parser.add_argument('--kleps', type=float, default=1.0)
  #train#
